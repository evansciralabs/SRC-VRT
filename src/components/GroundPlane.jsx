...
export default function GroundPlane({ children, isPitchMode, hardwareTrigger, groundImage, setGroundImage, isAmbi, theme, themeCfg }) {
  ...
  return (
    <div className={`ground-plane-container absolute inset-0 w-full h-full overflow-hidden flex items-center justify-center transition-colors duration-300 ${isPitchMode ? 'bg-transparent' : theme === 'daylight' ? 'bg-[#e4e4e7]' : 'bg-[#111]'}`}>
