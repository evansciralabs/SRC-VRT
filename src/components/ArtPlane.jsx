...
export default function ArtPlane({ children, isPitchMode, isActive, clearPayload, isAmbi, themeCfg, onCyclePrev, onCycleNext, onStamp, stampedCount, isLocked, stampTrigger, onCornersChange, onScaleChange }) {
