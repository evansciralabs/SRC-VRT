...
export default function App() {
  ...
  const executeRenderPipeline = async (prefix, includeGridlines) => {
    ...
    try {
      // Capture the full viewport so off-canvas transforms aren't clamped.
      // The HUD is hidden via isPitchMode; only the ground image + stamped
      // layers + active art plane are visible at capture time.
