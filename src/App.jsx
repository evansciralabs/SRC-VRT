...
export default function App() {
  ...
  const executeRenderPipeline = async (prefix, includeGridlines) => {
    ...
    try {
      ...
      // Step 3: Mathematical bounds from ground image rect + layer centroids.
      // Reliable regardless of canvas taint.
      ...
      try {
        ...
        if (scanImg.width > 0) {
          ...
          // Use pixel scan result only if it's tighter than mathematical bounds
          if (pr > pl && pb > pt) {
